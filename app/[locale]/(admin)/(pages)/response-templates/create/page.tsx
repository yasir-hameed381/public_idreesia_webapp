...
const CreateResponseTemplatePage = () => {
    ...
    return (
      <div className="min-h-screen bg-gray-50 p-4 flex items-center justify-center">
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <p className="text-gray-700 mb-6">You don't have permission to create response templates.</p>
          <Link
  ...
  return (
    <PermissionWrapper requiredPermission={PERMISSIONS.CREATE_RESPONSE_TEMPLATES}>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="text-gray-600">Create a new response template</p>
            </div>
            <Link
              href="/response-templates"
...
export default CreateResponseTemplatePage;
